...
1. Provide the parameter values for the blueprint assignment:
   ...
   - Basics
     ...
     - Azure Blueprint uses a default system assigned managed identity option or the user assigned identity managed identity to deploy          all artifacts in the assigned blueprint.
       To learn more, see
